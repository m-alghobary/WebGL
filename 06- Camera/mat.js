const mat3 = {
	...
	translate: function (m, tx, ty) {
		return mat.multiply(m, mat.translation(tx, ty));
	},

	rotate: function (m, angleInRadians) {
		return mat.multiply(m, mat.rotation(angleInRadians));
	},

	scale: function (m, sx, sy) {
		return mat.multiply(m, mat.scaling(sx, sy));
	},
...
const mat4 = {
	...
	lookAt: function (cameraPosition, target, up) {
		var zAxis = mat4.normalize(mat4.subtractVectors(cameraPosition, target));
